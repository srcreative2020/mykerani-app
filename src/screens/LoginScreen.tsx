...
const DEMO_USERS = [
  {
    ...
    label: "HQ Console (Pentadbir Sistem)",
    sublabel: "HQ_ADMIN · MYKERANI Kawalan Pentadbiran Utama",
    emoji: "👑",
    colorBg: "bg-rose-50",
  ...
  },
  {
    ...
    label: "Pemilik Perniagaan (Tenant Owner)",
  ...
  },
  {
    ...
    label: "Kakitangan (Staff Account)",
    sublabel: "STAFF · MYKERANI Urus Niaga Utama",
    emoji: "👤",
