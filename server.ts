...
Provide your output precisely formatted as raw JSON matching exactly this shape, with no markdown code fences and no extra commentary outside the JSON object:
{
  ...
  "financialIntent": { "detected": false, "type": "INCOME|EXPENSE|DEBT|RECEIVABLE|PAYABLE|COMMITMENT|null", "amount": 0, "relatedParty": "string|null", "rawText": "string" },
  "suggestions": [
    ...
    { "id": "string", "title": "string", "description": "string", "actionType": "CONFIRM_TRANSACTION", "payload": { "transactionType": "INCOME|EXPENSE|DEBT|RECEIVABLE|PAYABLE|COMMITMENT", "category": "string", "amount": 0, "date": "YYYY-MM-DD", "relatedParty": "string", "confidenceScore": 0.0 } }
  ],
